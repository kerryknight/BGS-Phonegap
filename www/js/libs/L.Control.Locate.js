        ...
        L.DomEvent
            ...
            .on(link, 'click', function() {
                // if (self._active && (map.getBounds().contains(self._event.latlng) || !self.options.setView ||
                    // isOutsideMapBounds())) {
                if (self._active && self._event != undefined && (map.getBounds().contains(self._event.bounds) || !self.options.setView ||
                    isOutsideMapBounds())) {//knightka changed self._event.bounds and added self._event != undefined
                    stopLocate();
                } else {
        ...
        var visualizeLocation = function() {
            ...
            if (self._locateOnNextLocationFound) {
                if (isOutsideMapBounds()) {
                    ...
                    map.setView([self._event.latitude, self._event.longitude], 13);//knightka added
                }
