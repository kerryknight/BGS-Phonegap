...
//////////////////////////////////////////////////////////////////////////////////////
// Kerry Knight - updated all 'Backbone' references to 'Parse' for use with Parse SDK
// As the Parse SDK is a fork of Backbone and is a drop-in replacement for this library
//////////////////////////////////////////////////////////////////////////////////////
...
(function (root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        // AMD
        define(['jquery', 'underscore', 'parse'], factory);
    } else {
        // Browser globals
        root.BackStack = factory((root.jQuery || root.Zepto || root.ender), root._, root.Parse);
    }
}(this, function ($, _, Parse) {
...
define('StackNavigator',['effects/SlideEffect'], function (SlideEffect) {
    ...
    function appendView(view, stackNavigator) {
        ...
        if (!view.__backStackRendered__) {
            ...
            // Setting default styles //knightka changed from overflow: hidden
            view.$el.css({position:'absolute', visibility:'hidden', overflow:'visible', width:'100%', height:'100%'});
    ...
    var StackNavigator = Parse.View.extend(
        /** @lends BackStack.StackNavigator */
        {
             ...
             *
             * @param {Object} options This is a Parse.View options hash that can have popTransition and pushTransition
            ...
            initialize:function (options) {
                ...
                this.$el.css({overflow:'visible'});//knightka changed from hidden
             ...
             *
             * @param {Parse.View || Parse.ViewClass} view View class or view instance to be pushed to the stack.
             ...
             *
             * @param {Parse.View || Parse.ViewClass} view View class or view instance to be pushed on top of the stack instead of current one.
             ...
             *
             * @param {Parse.View || Parse.ViewClass} view View class or view instance to be pushed on top of the stack.
             * @param {Object} viewOptions Hash with options to be passed to the view, if view param is not an instance.
             * @param {Effect} transition Transition effect to be played when replacing views.
             */
