...
(function ($) {
    ...
    Freeow.prototype = {
        ...
        show: function () {
			$('#freeow').fadeIn();//in case we had to fade it out elsewhere when opening our panel
    ...
    if (typeof $.fn.freeow === "undefined") {
        ...
        $.fn.freeow.defaults = {
            ...
            prepend: true,
            startStyle: null,
            showStyle: {opacity: 1.0, bottom: 0},
            showDuration: 250,
            hideStyle: {opacity: 0.0, bottom: "-100%"},
            hideDuration: 500,
            ...
            template: function (title, message) {
                ...
                e = [
                    '<div>',
                    '<div class="freeow-background">',
                    '<div class="freeow-content">',
                    '<h2>' + title + '</h2>',
                    '<p>' + message + '</p>',
                    '</div>',
                    '</div>',
                    //'<span class="icon"></span>',//uncomment to add a graphic
