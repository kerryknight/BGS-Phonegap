    ...
    if (error) {
        ...
        if (error.fberrorShouldNotifyUser) {
            ...
            if (underlyingSubCode == 458) {
                alertMessage = @" The app was removed from Facebook. Please attempt to log in with Facebook again.";
            } else {
                alertMessage = @" Your current session is no longer valid. Please log in with Facebook again.";
            }
